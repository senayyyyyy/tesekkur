...
class MonoTV:
    ...
    def yayin_urlini_al(self):
        json_endpoint = "https://vavoo.vercel.app/api/stream.js?url=https://www.selcuksportshd1826.xyz&referer=https://www.selcuksportshd1826.xyz&useragent=okhttp/4.12.0"
        log.log(f"[cyan][~] çağrılıyor: {json_endpoint}")
        try:
